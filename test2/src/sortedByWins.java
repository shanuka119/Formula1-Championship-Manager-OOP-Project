...
public class sortedByWins implements ActionListener {
    ...
    sortedByWins(){
        ...
        frame.setTitle("Table Sorted with most wins");
        ...
        for (Formula1Driver formula1Driver: Formula1ChampionshipManager.sortedByWinsArrayList){
