...
public class sortDates implements ActionListener {
    //Creating the new GUI frame with first positions table
    ...
    sortDates(){
        ...
        for (int i = 0; i < Formula1ChampionshipManager.dates.size(); i++){
            Object[] rows = {Formula1ChampionshipManager.dates.get(i)};
            table.addRow(rows);
